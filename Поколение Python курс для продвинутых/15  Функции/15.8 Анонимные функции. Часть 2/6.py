...
numbers = [46, 61, 34, 17, 56, 26, 93, 1, 3, 82, 71, 37, 80, 27, 77, 94, 34, 100,
           ...
           4, 23, 52, 39, 63, 74, 15, 66, 29, 88, 94, 37, 44, 2, 38, 36, 32, 49, 5,
           33, 60, 94, 89, 8, 36, 94, 46, 33]
pow_nums = list(map(lambda n: n//2 if n%2==0 else n, numbers))
result = list(filter(lambda x: x if not(x%2 != 0 and x > 47) else False,pow_nums))
print(*result,sep=' ')