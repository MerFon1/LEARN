...
v,d = [int(input()) for i in range(2)]
ls = [[int(i) for i in input().split()] for i in range(v)]
nm = max(max(ls, key=max))

print(*(nested_index(ls,nm)))