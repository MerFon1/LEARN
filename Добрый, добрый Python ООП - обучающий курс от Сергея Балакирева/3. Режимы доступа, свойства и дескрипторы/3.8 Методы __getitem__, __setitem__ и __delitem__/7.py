...
class TicTacToe:
    ...
    def __getitem__(self, item):
        indx1, indx2 = item[0], item[1]

        if type(indx1) == slice:
            return tuple(self.pole[i][indx2].value for i in range(3))
        elif type(indx2) == slice:
            return tuple(self.pole[indx1][j].value for j in range(3))
